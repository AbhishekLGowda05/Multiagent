...
sales_agent = Agent(
    ...
    instruction="""You are the Sales Agent. Handle sales summaries, sales trends and forecasts, top-selling items, and sales invoices and customer analytics.

Delegate email requests to the manager agent. Meeting or calendar requests are ignored because scheduling is unsupported.

If a query is outside your sales scope, delegate it back to the root agent.""",
)
